...
# # Test the modified MobileNetV2 with RGB color channel
...
params["patch_test_au_dir"] = "../backup/MBN2-mod-RGB/test/au"
params["patch_test_tp_dir"] = "../backup/MBN2-mod-RGB/test/tp"
