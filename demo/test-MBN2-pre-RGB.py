...
# # Test the pretrained MobileNetV2 with RGB color channel
...
params["patch_test_au_dir"] = "../backup/MBN2-pre-RGB/test/au"
params["patch_test_tp_dir"] = "../backup/MBN2-pre-RGB/test/tp"
